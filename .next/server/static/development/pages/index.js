...
/* harmony import */ var _test_reducer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../test-reducer */ "./test-reducer.js");
var __jsx = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement;
...
class Index extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  static async getInitialProps({
    ...
    await reduxStore.dispatch(Object(_test_reducer__WEBPACK_IMPORTED_MODULE_4__["fetchPosts"])());
  ...
  render() {
    return __jsx("div", null, __jsx("h1", null, "Home page "), __jsx("div", null, this.props.posts.map(post => __jsx("p", {
      key: post.id
    }, post.title))));
  }
...
/* harmony default export */ __webpack_exports__["default"] = ((state = initialState, action) => {
  switch (action.type) {
    case SET_POSTS:
      return _babel_runtime_corejs2_core_js_object_assign__WEBPACK_IMPORTED_MODULE_7___default()({}, _objectSpread({}, state, {
        posts: action.posts
      }));
...
const fetchPosts = () => {
  return async dispatch => {
    const response = await _api__WEBPACK_IMPORTED_MODULE_8__["postsAPI"].list(); //console.log('res', response.data);
