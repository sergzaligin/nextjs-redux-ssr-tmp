...
/* harmony import */ var _store_actions_test__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../store/actions/test */ "./store/actions/test.js");
...
class Index extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  static async getInitialProps({
    ...
    await reduxStore.dispatch(Object(_store_actions_test__WEBPACK_IMPORTED_MODULE_2__["fetchPosts"])());
    const posts = reduxStore.getState().testPage.posts; //console.log('STATE!!!', posts);
...
/* harmony import */ var _types_test__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../types/test */ "./store/types/test.js");


const setPosts = posts => ({
  type: _types_test__WEBPACK_IMPORTED_MODULE_1__["SET_POSTS"],
  posts
});
const fetchPosts = () => {
  return async dispatch => {
    const response = await _api__WEBPACK_IMPORTED_MODULE_0__["postsAPI"].list(); //console.log('res', response.data);
